...
<br>
--
```{r, out.width="10%", fig.cap="<center><b>Bolsa de estudos - Curso-R</center></b>"}
...
knitr::include_graphics("img/rlogos/hex-shiny.jpg")
```
...
```{r, out.width="70%", fig.cap="<center><b>Fonte: Apresentação de <a href='https://deanattali.com/blog/building-shiny-apps-tutorial/'> Dean Attali</a> </b></center>"}
knitr::include_graphics("img/what_is_shiny.png")
```
